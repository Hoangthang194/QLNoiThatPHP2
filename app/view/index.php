...
if (isset($_SESSION['user_id']) && $_SESSION['role'] == "admin") {
  $getData = new Getdata();
  $results =$getData->GetUserAll();
  foreach($results as $result){
    if($result["role"] == "user"){
      $_SESSION["idSubmit"] = $result["UserID"];
    break;
    }
...
<div class="wrapper">
  ...
  <div class="mb-3">
  <button class="btn btn-primary" type="button"><a href="./insert.php" style="color: white;">Thêm sản phẩm</a></button>
  </div>
  <!-- Add Item Form -->
  ...
  <tbody>
    ...
    <td>'.$result["Priceold"].'</td>
    <td>'.$result["IsState"].'</td>
    <td><a href="../view/insert.php?id='.$result["productId"].' &isUpdate='.true.'">Sửa</a></td>
    <td><a href="../controller/delete.php?id='.$result["productId"].'">Xóa</a></td> 
    </tr>
    ';  
    $stt++;
    }
