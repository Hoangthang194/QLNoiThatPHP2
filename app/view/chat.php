      ...
      <section class="chat">
        ...
        <div class="messages-chat">
          ...
          foreach($userlst as $user){
            ...
            //Kiểm tra xem có tin nhắn của người dùng này không
            $results = $getData->getMessageByID($user["UserID"]);
            if($results == false){
              continue;
            }
            $resultsMsg =$getData->getmsgWithRole($_SESSION["UserID"],$_SESSION["idSubmit"]);
           ...
           ?>
          <!-- <img src="../../access/img/logo.png" alt="" class="img"> -->
